use chrono::{Date, DateTime, FixedOffset, Local, NaiveDate, NaiveDateTime, ParseError, ParseResult, TimeZone, Utc};
...
pub fn fixed_offset_datetime_to_local(fixed_offset_datetime: DateTime<FixedOffset>) -> DateTime<Local> {
  DateTime::from(fixed_offset_datetime)
}
